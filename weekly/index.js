...
(()=>{
    ...
    function main(data) {
      ...
      const output = gui_issues.map((itm) => {
        ...
        return `${itm.title}  --${itm?.assignees?.nodes
          ...
          .map((itm) => authors[itm])
          .join(",")} --${gui_label.replace(/(GUI::)/, "").replace(/\s+/g, "")} ${
  ...
  if (location.pathname.includes("fortiwebcloud/fortiwebcloud")) {
    fetch("https://dops-git106.fortinet-us.com/api/graphql", {
      "headers": {
        "accept": "*/*",
        "accept-language": "en-US,en;q=0.9,zh-US;q=0.8,zh;q=0.7,zh-CN;q=0.6,pt;q=0.5,zh-TW;q=0.4",
  ...
  if (location.pathname.includes("dolphin/controller")) {
    fetch("https://dops-git.fortinet-us.com/api/graphql", {
      "headers": {
        ...
        "sec-fetch-mode": "cors",
        "sec-fetch-site": "same-origin",
        "x-csrf-token": "U25Jtraxey0CVgoibWqWYWZIUP0SndrAPoLKYcJvIuauStKYhE66cPaVzoNifkO1hVPd1NvxI8sQC/5YQINvyQ==",
        "x-gitlab-feature-category": "team_planning"
      },
      "referrer": "https://dops-git.fortinet-us.com/dolphin/controller/-/issues/?sort=created_date&state=opened&milestone_title=1.0-GA&first_page_size=100",
      "referrerPolicy": "strict-origin-when-cross-origin",
      "body": `[{\"operationName\":\"getIssues\",\"variables\":{\"hideUsers\":false,\"isProject\":true,\"isSignedIn\":true,\"fullPath\":\"dolphin/controller\",\"sort\":\"CREATED_DESC\",\"state\":\"opened\",\"firstPageSize\":100,\"search\":\"[GUI]\",\"milestoneTitle\":\"${location.search.split('&').find(itm=>itm.indexOf('milestone_title')===0).split('=').pop()}\",\"types\":[\"ISSUE\",\"INCIDENT\",\"TEST_CASE\",\"TASK\"]},\"query\":\"query getIssues($hideUsers: Boolean = false, $isProject: Boolean = false, $isSignedIn: Boolean = false, $fullPath: ID!, $iid: String, $search: String, $sort: IssueSort, $state: IssuableState, $assigneeId: String, $assigneeUsernames: [String!], $authorUsername: String, $confidential: Boolean, $labelName: [String], $milestoneTitle: [String], $milestoneWildcardId: MilestoneWildcardId, $myReactionEmoji: String, $releaseTag: [String!], $releaseTagWildcardId: ReleaseTagWildcardId, $types: [IssueType!], $crmContactId: String, $crmOrganizationId: String, $not: NegatedIssueFilterInput, $beforeCursor: String, $afterCursor: String, $firstPageSize: Int, $lastPageSize: Int) {\\n  group(fullPath: $fullPath) @skip(if: $isProject) {\\n    id\\n    issues(\\n      includeSubgroups: true\\n      iid: $iid\\n      search: $search\\n      sort: $sort\\n      state: $state\\n      assigneeId: $assigneeId\\n      assigneeUsernames: $assigneeUsernames\\n      authorUsername: $authorUsername\\n      confidential: $confidential\\n      labelName: $labelName\\n      milestoneTitle: $milestoneTitle\\n      milestoneWildcardId: $milestoneWildcardId\\n      myReactionEmoji: $myReactionEmoji\\n      types: $types\\n      crmContactId: $crmContactId\\n      crmOrganizationId: $crmOrganizationId\\n      not: $not\\n      before: $beforeCursor\\n      after: $afterCursor\\n      first: $firstPageSize\\n      last: $lastPageSize\\n    ) {\\n      pageInfo {\\n        ...PageInfo\\n        __typename\\n      }\\n      nodes {\\n        ...IssueFragment\\n        reference(full: true)\\n        __typename\\n      }\\n      __typename\\n    }\\n    __typename\\n  }\\n  project(fullPath: $fullPath) @include(if: $isProject) {\\n    id\\n    issues(\\n      iid: $iid\\n      search: $search\\n      sort: $sort\\n      state: $state\\n      assigneeId: $assigneeId\\n      assigneeUsernames: $assigneeUsernames\\n      authorUsername: $authorUsername\\n      confidential: $confidential\\n      labelName: $labelName\\n      milestoneTitle: $milestoneTitle\\n      milestoneWildcardId: $milestoneWildcardId\\n      myReactionEmoji: $myReactionEmoji\\n      releaseTag: $releaseTag\\n      releaseTagWildcardId: $releaseTagWildcardId\\n      types: $types\\n      crmContactId: $crmContactId\\n      crmOrganizationId: $crmOrganizationId\\n      not: $not\\n      before: $beforeCursor\\n      after: $afterCursor\\n      first: $firstPageSize\\n      last: $lastPageSize\\n    ) {\\n      pageInfo {\\n        ...PageInfo\\n        __typename\\n      }\\n      nodes {\\n        ...IssueFragment\\n        __typename\\n      }\\n      __typename\\n    }\\n    __typename\\n  }\\n}\\n\\nfragment PageInfo on PageInfo {\\n  hasNextPage\\n  hasPreviousPage\\n  startCursor\\n  endCursor\\n  __typename\\n}\\n\\nfragment IssueFragment on Issue {\\n  id\\n  iid\\n  confidential\\n  createdAt\\n  downvotes\\n  dueDate\\n  hidden\\n  humanTimeEstimate\\n  mergeRequestsCount\\n  moved\\n  state\\n  title\\n  updatedAt\\n  closedAt\\n  upvotes\\n  userDiscussionsCount @include(if: $isSignedIn)\\n  webPath\\n  webUrl\\n  type\\n  assignees @skip(if: $hideUsers) {\\n    nodes {\\n      id\\n      avatarUrl\\n      name\\n      username\\n      webUrl\\n      __typename\\n    }\\n    __typename\\n  }\\n  author @skip(if: $hideUsers) {\\n    id\\n    avatarUrl\\n    name\\n    username\\n    webUrl\\n    __typename\\n  }\\n  labels {\\n    nodes {\\n      id\\n      color\\n      title\\n      description\\n      __typename\\n    }\\n    __typename\\n  }\\n  milestone {\\n    id\\n    dueDate\\n    startDate\\n    webPath\\n    title\\n    __typename\\n  }\\n  taskCompletionStatus {\\n    completedCount\\n    count\\n    __typename\\n  }\\n  __typename\\n}\\n\"}]`,
      "method": "POST",
      "mode": "cors",
      "credentials": "include"
    }).then(r => r.json()).then(r=>f(r, 'groupby:state'));
